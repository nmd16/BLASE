...
FullDataRunThetaOut <- read.csv("N:/Simulations/MainOnly/MainOrigEthnicRun/MainErrorOrigEthnicRunThetaOut.txt", quote="\"",header=F)
...
GMThetaOut <- read.csv("N:/Simulations/MainOnly/MainOrigEthnicRun/GMainErrorOrigEthnicRunThetaOut.txt", quote="\"",header=F)
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CIPB_NoLines.pdf")
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CIPB_Intercept.pdf")
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CIPB_Math.pdf")
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CIPB_EthB.pdf")
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CIPB_EthH.pdf")
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CIPB_Male.pdf")
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CI_All.pdf")
...
# Int ONLY 
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CI_Intercept.pdf")
...
# MATH ONLY 
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CI_Math.pdf")
...
# EthB ONLY 
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CI_EthB.pdf")
...
# EthH ONLY 
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/FiguresCI_EthH.pdf")
...
# SexM ONLY 
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/CI_SexM.pdf")
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/MatchPercent.pdf")
boxplot( GMatch[c(200:441)]/(N/2), BMatch[-c(1:50)]/(N/2), at=c(2,3),border = "white", names=c("GM","BLASE"),xlab = "Matches")
#points(x =2.5, y = truthCoefs[5], pch = 15)
...
pdf("N:/Simulations/MainOnly/MainOrigEthnicRun/Figures/Match.pdf")
boxplot( GMatch[c(200:441)], BMatch[-c(1:50)], at=c(2,3),border = "white", names=c("GM","BLASE"),xlab = "Matches")
#points(x =2.5, y = truthCoefs[5], pch = 15)
plotCI(c(2,3),meanvec,ui=ui1,li=li1,xlab ="",ylab = "Point Estimate", add=T)
dev.off()
