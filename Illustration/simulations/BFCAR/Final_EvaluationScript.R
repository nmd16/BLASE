...
pdf("N:/Simulations/BFCAR/Figures/BFCARPaper.pdf",width = 11, height = 7 )
#par(mar=c(5,3,2,2)+0.1)
boxplot( PB[c(300:341),1],GM[c(300:341),1],ExtNew2[-c(1:150),1] , PB[c(100:341),2], GM[c(100:341),2],ExtNew2[-c(1:50),2],PB[c(100:341),3], GM[c(100:341),3],ExtNew2[-c(1:50),3],PB[c(100:341),4],GM[c(100:341),4],ExtNew2[-c(1:50),4],PB[c(100:341),5],GM[c(100:341),5],ExtNew2[-c(1:50),5],border="white",xlim=c(0,15),names=rep(c("PB","GM","BL"),5))
